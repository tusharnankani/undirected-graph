...
Thank you to [Harsh Kapadia](https://twitter.com/harshgkapadia) for pushing me to document my thought process about this project. Shoutout to [Aditya Oberai](https://twitter.com/adityaoberai1) for convincing me to write a blog irrespective of the simplicity or complexity of the topic and asked me to convert short form content to long form content.  
