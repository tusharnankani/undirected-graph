...
1. [EQ](https://wikipedia.org/wiki/Emotional_intelligence) beats IQ by a huge margin when working within teams.
...
And the most natural thing I did mid-way through the Hackathon — `git clone`'d our repository into the AWS CloudShell.
