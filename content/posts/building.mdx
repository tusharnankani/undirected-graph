...
I remember, in school I used to multiply and divide with the exact numbers - until I was taught that common factors can be cancelled out.

I still seem to follow it.
...
I remember the sole purpose of building it was because I saw someone build a similar website in React.js and however me not knowing the framework at the time, used to think in HTML & CSS and thereby I built it (to prove I can do it, even better, I think?) 
...
And maybe that's why we should explore all the tools. And then identify for ourselves. 
