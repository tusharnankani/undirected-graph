...
This log will talk about my overall experience of the [JP Morgan Chase & Co](https://www.jpmorganchase.com/) internship process and the Hackathon.
...
In this, I not only talk about the experience but also a few suggestions and learnings that I would have done if I were at your place.
...
Reason being? You are being shortlisted on the basis of DSA (and Video Interview as well). Which implies your dev skills aren't being tested for a Hackathon. The system is like that.
...
If you've been just doing CP, maybe start a with devlopment. You need to be able to contribute during the Hackathon.
...
The factors that I think would help:
- Take up initiative.
- Be flexible.
...
There are a lot of ifs involved. Therefore, it is always better to be prepare for the worst.
