...
And thankful to [Harsh Kapadia](https://harshkapadia.me) for the push to _just_ start writing and to ship it. And a billion other things.
...
![Resonating Circles](/images/beginning-resonating-circle.jpg)

## Undirected Graph

The overload of ideas has pushed me to connect the dots, analogous to my directionless, although somehow connected thoughts forming a [data structure](https://en.wikipedia.org/wiki/Graph_(discrete_mathematics)) - **Undirected Graph**.
...
<p>
  <TwitterTweetEmbed tweetId={"1484752668933632003"} />
</p>

So here we go — brings me to the end (or **The Beginning**?). 
